...
type CacheOrder struct {
	...
	Id                string             `json:"id"`
	Offer             uint32             `json:"offer"`
	DeliveryCost      float32            `json:"delivery_cost"`
	DeliveryTimeStamp time.Time          `json:"delivery_time_stamp"`
}

func (m *CacheOrder) Marshal() []byte {
...
func UnmarshalCacheOrder(data []byte, m *CacheOrder) {
